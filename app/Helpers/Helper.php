...
class Helper
{
    ...
    public static function sendExpenseWarning($expense, $branch)
    {
        ...
        elseif ($branch->branch_name = "Buah Batu") {
            $phones = ['081322999456', '081220002211', '081220002211', '081214994364'];   
        }
        elseif ($branch->branch_name = "Banceuy")
        {
            $phones = ['081322999456', '08122363622', '08122440040', '081220002211', '081214994364'];
        }
        else
        {
            $phones = ['081322999456', '08122363622', '08122440040', '081220002211', '081214994364'];   
